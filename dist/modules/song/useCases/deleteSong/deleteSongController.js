...
const deleteSongUseCase_1 = require("./deleteSongUseCase");
class DeleteSongController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const deleteSongUseCase = tsyringe_1.container.resolve(deleteSongUseCase_1.DeleteSongUseCase);
            const { id } = request.params;
            yield deleteSongUseCase.execute({
                id
            });
